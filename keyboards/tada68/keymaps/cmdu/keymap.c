...
[_BL] = LAYOUT_ansi(
  ...
  KC_LSPO,         KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,   KC_DOT,   KC_SLSH, KC_RSPC, KC_BRIU,	KC__VOLUP, \
  MOD_HYPR, KC_LALT, KC_LGUI,       			   KC_SPC,    			     KC_RALT, MO(_FL), KC_MRWD, KC_MFFD, KC_BRID, 	KC__VOLDOWN),
